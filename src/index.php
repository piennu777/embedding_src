...
<meta charset="utf-8" />
    ...
    <meta property="og:image" content="https://pien.red/t/embedding/header.jpg">
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="https://github.com/piennu777/embedding_src"><i class="fa-brands fa-github"></i></a></li>
            </ul>
        </nav>
    </header>
